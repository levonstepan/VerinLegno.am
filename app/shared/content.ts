export const hyContent = {
  ...
  products: {
    ...
    items: [
      { name: "Քրիստալ էպոքսիդ", href: "/catalogues/Crystal epox ENG.pdf", image: "/images/catalogues/Crystal Epox.jpeg", pdf: "/catalogues/Crystal epox ENG.pdf" },
      { name: "Փայտի յուղ", href: "/catalogues/WOOD-OIL.pdf", image: "/images/catalogues/Wood oil.jpeg", pdf: "/catalogues/WOOD-OIL.pdf" },
      ...
      { name: "Ապակի", href: "#products" },
    ] as const,
  },
  catalogues: {
    title: "Տեխնիկական փաստաթղթեր",
    badge: "Ռեսուրսներ",
    description: "Դիտեք մեր ապրանքների կատալոգների և տեխնիկական փաստաթղթերի համապարփակ հավաքածուն",
    pdfLabel: "PDF",
  ...
  services: {
    ...
    description:
      "Verinchrome գունավորման համակարգը թույլ է տալիս առավելագույն հուսալիությամբ վերարտադրել լայն շրջանակի պիգմենտավորված հիմքեր և ավարտական ծածկույթներ ջրային և լուծիչային հիմքով նյութերում՝ ապահովելով պարզ, արագ և ճկուն աշխատանքային գործընթաց։ Նախագծված է մասնագետների համար, ովքեր գնահատում են ճշգրտությունը, Verinchrome-ը ապահովում է խելացի և ինտուիտիվ մոտեցում գույնի ստեղծմանը:  Բարձրորակ պիգմենտները ապահովում են համահունչ երանգներ տարբեր նյութերի վրա — փայտ, մետաղ և պլաստիկ: Համակարգը ինչպես ձեռքով, այնպես էլ ավտոմատ գունավորման համար է և հնարավորություն տալիս արհեստանոցներին, արտադրական ձեռնարկություններին և դիզայներներին ստանալ կատարյալ արդյունք։",
    cta: "Հարցերի դեպքում",
    ctaLink: "#contact",
  },
  workshops: {
    ...
    items: [
      {
        ...
        description:
          "Միացեք մեր համապարփակ վարպետաց դասերին՝ սովորելու փորձառու կիրառման տեխնիկաներ և լավագույն պրակտիկաներ արդյունաբերության մասնագետներից:",
        icon: "application",
      },
      {
      ...
      },
      {
        ...
        description:
          "Տիրապետեք գունավորման արվեստին մեր մասնագիտական ուսուցման ծրագրերի միջոցով:",
        icon: "color",
      },
      {
        title: "Որակի վերահսկում",
        description:
          "Իմացեք որակի չափանիշներն ու ստուգման առաջադեմ մեթոդները՝ ստանալու մշտապես անթերի վերջնական արդյունք։",
        icon: "quality",
      },
    ] as const,
  ...
  about: {
    ...
    rootsText:
      "Roots Furniture ՍՊԸ-ն Հայաստանում կահույքի արտադրող ընկերություն է, որը շուկայում ներկայացված է Acobian Furniture ապրանքանիշով: Երկու տասնամյակից ավելի փորձով Roots Furniture ՍՊԸ-ն դարձել է Հայաստանի առաջատար արտադրողներից մեկը բարձրորակ փայտե կահույքի արտադրության ոլորտում:\n\nRoots Furniture ՍՊԸ-ն VerinLegno Italy-ի պաշտոնական/բացառիկ ներկայացուցիչն է Հայաստանում, ուստի VerinLegno ծածկույթների և նախապատրաստական լուծումների մատակարարումը Հայաստանում իրականացվում է մեր կողմից:",
  ...
  footer: {
    ...
    madeWith: "Պատրաստված է ❤-ով՝ Հայաստանում",
  },
  privacyPolicy: {
    ...
    sections: {
      introduction: {
        ...
        content: 'Roots Furniture ՍՊԸ-ն ("մենք", "մեր" կամ "մեզ") գործարկում է verinlegno.am կայքը ("Կայք"): Այս Գաղտնիության Քաղաքականությունը բացատրում է մեր պրակտիկաները մեր Կայքի տեղեկատվության վերաբերյալ:',
      },
      noDataCollection: {
        title: "2. Տվյալների Հավաքագրում",
        content: "Մենք չենք հավաքում, չենք պահում կամ չենք մշակում անձնական տվյալներ մեր Կայքի այցելուներից: Մեր Կայքը զուտ տեղեկատվական է և չի ներառում․",
        items: [
          "Անձնական տեղեկատվություն հավաքող կոնտակտային ձևանմուշներ",
          "Օգտատիրական հաշիվներ կամ գրանցման համակարգեր",
          "Նորությունների բաժանորդագրություններ",
          "Cookies տվյալների վերլուծություն և հետևում",
      ...
      changes: {
        title: "5. Գաղտնիության Քաղաքականության Փոփոխություններ",
...
export const enContent = {
  ...
  products: {
    ...
    items: [
      { name: "Crystal Epox", href: "/catalogues/Crystal epox ENG.pdf", image: "/images/catalogues/Crystal Epox.jpeg", pdf: "/catalogues/Crystal epox ENG.pdf" },
      { name: "Wood oil", href: "/catalogues/WOOD-OIL.pdf", image: "/images/catalogues/Wood oil.jpeg", pdf: "/catalogues/WOOD-OIL.pdf" },
      { name: "Stains", href: "/catalogues/Stains.pdf", image: "/images/catalogues/Stains.jpeg", pdf: "/catalogues/Stains.pdf" },
      { name: "Patinas", href: "/catalogues/Patinas.pdf", image: "/images/catalogues/Patinas.jpeg", pdf: "/catalogues/Patinas.pdf" },
      { name: "Firefighter", href: "/catalogues/Firefighter.pdf", image: "/images/catalogues/Firefighter.png", pdf: "/catalogues/Firefighter.pdf" },
      { name: "Parquet", href: "/catalogues/Parquet.pdf", image: "/images/catalogues/Parquet.png", pdf: "/catalogues/Parquet.pdf" },
      { name: "Special Effects", href: "/catalogues/Effetti speciali.pdf", image: "/images/catalogues/Special Effects.png", pdf: "/catalogues/Effetti speciali.pdf" },
      { name: "Verin-Sea Finishing", href: "/catalogues/VERIN-SEA FINISHING.pdf", image: "/images/catalogues/Verin-Sea Finishing.png", pdf: "/catalogues/VERIN-SEA FINISHING.pdf" },
