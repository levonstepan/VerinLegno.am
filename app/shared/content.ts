export const hyContent = {
  ...
  about: {
    ...
    rootsText:
      "Roots Furniture ՍՊԸ-ն Հայաստանում կահույքի արտադրող ընկերություն է, որը շուկայում ներկայացված է Acobian Furniture ապրանքանիշով: Երկու տասնամյակից ավելի փորձով Roots Furniture-ը դարձել է Հայաստանի առաջատար արտադրողներից մեկը բարձրորակ փայտե կահույքի արտադրության ոլորտում:\n\nRoots ՍՊԸ-ն VerinLegno Italy-ի պաշտոնական/բացառիկ ներկայացուցիչն է Հայաստանում, ուստի VerinLegno ծածկույթների և նախապատրաստական լուծումների մատակարարումը Հայաստանում իրականացվում է մեր կողմից:",
