      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2 group relative">
            ...
            <div className="relative bg-white rounded-2xl p-6 border-2 border-neutral-200 shadow-lg hover:shadow-xl transition-all duration-300">
              {/* Armenia flag icon */}
              ...
              <p className="text-neutral-700 leading-relaxed mb-4 text-sm">{content.rootsText}</p>
        ...
        {/* Single More Button under the Roots Furniture section */}
        <div className="mt-6 flex justify-end md:justify-start md:ml-auto md:max-w-md">
          <Link
            href="#"
            className="inline-flex items-center justify-center px-8 py-3 rounded-lg font-medium bg-[#D70000] text-white hover:shadow-lg hover:shadow-[#D70000]/20 hover:scale-105 transition-all duration-300 w-full md:w-auto min-w-[200px]"
          >
            <span>More</span>
