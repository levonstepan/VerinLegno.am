      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-5 gap-8 md:gap-12">
          ...
          <div className="md:col-span-3 group relative flex flex-col">
            ...
            <div className="relative bg-white rounded-2xl p-4 border-2 border-neutral-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden flex-1 flex flex-col">
              ...
              <div className="mt-4">
                ...
                >
                  <span>Know More About VerinLegno</span>
          ...
          <div className="md:col-span-2 group relative flex flex-col">
            ...
            <div className="relative bg-white rounded-2xl p-6 border-2 border-neutral-200 shadow-lg hover:shadow-xl transition-all duration-300 flex-1 flex flex-col">
              ...
              <Link
                href="#"
                className="inline-flex items-center justify-center w-full px-6 py-3 rounded-lg font-medium bg-[#D70000] text-white hover:shadow-lg hover:shadow-[#D70000]/20 hover:scale-105 transition-all duration-300 mt-auto"
              >
                <span>Know More About Partnership</span>
                <svg className="w-5 h-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </Link>
